...
DROP TRIGGER IF EXISTS evaluation_general_scene_results_immutable
    ON evaluation_general_scene_results;
DROP FUNCTION IF EXISTS reject_evaluation_general_scene_result_mutation();
DROP TRIGGER IF EXISTS evaluation_general_scene_results_binding
    ON evaluation_general_scene_results;
DROP FUNCTION IF EXISTS evaluation_assert_general_scene_result_binding();
DROP TABLE IF EXISTS evaluation_general_scene_results;
DROP FUNCTION IF EXISTS
    evaluation_general_scene_result_shape_is_valid(jsonb);

DROP TRIGGER evaluation_module_runs_identity_immutable
    ON evaluation_module_runs;
DELETE FROM evaluation_module_runs
WHERE strategy_ref = 'general-scene-evaluation/v1';
