...
func (r *Repository) StageCandidate(
	ctx context.Context,
...
func (r *Repository) FindCandidate(
	ctx context.Context,
	ownerID string,
	candidateID string,
) (agentvoice.Candidate, error) {
...
func (r *Repository) findCandidateByUpload(
	ctx context.Context,
	ownerID string,
	threadID string,
...
func (r *Repository) ClaimTranscription(
	ctx context.Context,
	ownerID string,
	candidateID string,
	leaseDuration time.Duration,
...
func (r *Repository) ConfirmCandidate(
	ctx context.Context,
	ownerID string,
...
FOR UPDATE`,
	...
	if existing, found, findErr := conversationpostgres.
		...
		return agentvoice.Confirmation{}, mapConversationTransactionError(findErr)
	} else if found {
	...
	run, err := runpostgres.CreateInitialPendingRunInTransaction(
		ctx,
		tx,
	...
	if err != nil {
		return agentvoice.Confirmation{}, mapRunTransactionError(err)
	}
...
func (r *Repository) newConfirmationIDs() (
	string,
	string,
	string,
	string,
...
func (r *Repository) FindMessageAudio(
	ctx context.Context,
	ownerID string,
	audioID string,
) (conversation.MessageAudio, error) {
...
func (r *Repository) FindMessageByID(
	ctx context.Context,
	ownerID string,
	messageID string,
) (conversation.Message, error) {
...
func (r *Repository) BeginCandidateDeletion(
	ctx context.Context,
	ownerID string,
	candidateID string,
) (agentvoice.Candidate, error) {
...
func (r *Repository) FinishCandidateDeletion(
	ctx context.Context,
	ownerID string,
	candidateID string,
) (agentvoice.Candidate, error) {
...
func (r *Repository) BeginMessageAudioDeletion(
	ctx context.Context,
	ownerID string,
	audioID string,
) (conversation.MessageAudio, error) {
...
func (r *Repository) FinishMessageAudioDeletion(
	ctx context.Context,
	ownerID string,
	audioID string,
) (conversation.MessageAudio, error) {
...
func (r *Repository) FinishCleanup(
	ctx context.Context,
...
func (r *Repository) ReleaseCleanup(
	ctx context.Context,
	claim agentvoice.CleanupClaim,
) error {
	if !claim.Valid() || claim.Kind != agentvoice.CleanupCandidate {
...
func loadVoiceConfirmation(
	...
	if err != nil {
		return agentvoice.Confirmation{}, mapConversationTransactionError(err)
	}
	audio, err := scanMessageAudio(tx.QueryRow(ctx, `
SELECT `+messageAudioSelectColumns+`
FROM agent_message_audios
WHERE audio_id = $1
  AND owner_user_id = $2`,
	...
	run, err := runpostgres.FindRunInTransaction(
		ctx,
		tx,
		candidate.OwnerID,
		candidate.ConfirmedRunID,
...
func mapConversationTransactionError(err error) error {
	switch {
	case err == nil:
		return nil
...
func mapRunTransactionError(err error) error {
	switch {
	case err == nil:
		return nil
