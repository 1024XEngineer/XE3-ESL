...
// Repository persists image assets through the process-owned database pool.
type Repository struct {
	database *gorm.DB
}

// New adapts the process-owned pgx pool for the image persistence
// implementation without creating a second connection pool.
func New(pool *pgxpool.Pool) (*Repository, error) {
	database, err := newDatabaseFromPool(pool)
	if err != nil {
...
func newDatabaseFromPool(pool *pgxpool.Pool) (*gorm.DB, error) {
	if pool == nil {
		return nil, errors.New("agent image: database pool is required")
	}
...
func (r *Repository) findImageAssetByUpload(
	ctx context.Context,
	ownerID string,
	threadID string,
...
func (r *Repository) ListMessageAssets(
	ctx context.Context,
	ownerID string,
	threadID string,
	messageID string,
...
func (r *Repository) AttachAssets(
	ctx context.Context,
	ownerID string,
	threadID string,
	messageID string,
...
func (r *Repository) BeginDeletion(
	ctx context.Context,
	ownerID string,
	assetID string,
) (agentimage.Asset, error) {
...
func (r *Repository) FinishDeletion(
	ctx context.Context,
	ownerID string,
	assetID string,
) (agentimage.Asset, error) {
...
var _ agentimage.Repository = (*Repository)(nil)
