...
func (r *PostgresStore) CreateInitial(
	ctx context.Context,
	ownerID string,
	threadID string,
...
func (r *PostgresStore) CreateRetry(
	ctx context.Context,
	ownerID string,
	runID string,
...
func (r *PostgresStore) FindMessage(
	ctx context.Context,
	ownerID string,
	threadID string,
	messageID string,
...
func (r *PostgresStore) ListMessagesForContext(
	ctx context.Context,
	ownerID string,
	threadID string,
...
func (r *PostgresStore) SaveManifest(
	ctx context.Context,
...
func (r *PostgresStore) FindManifest(
	ctx context.Context,
	ownerID string,
	runID string,
) (agentcontext.Manifest, error) {
...
func (r *PostgresStore) SaveToolSnapshot(
	ctx context.Context,
	manifest agentcontext.Manifest,
) (agentcontext.Manifest, error) {
...
func (r *PostgresStore) ProposeToolCall(
	ctx context.Context,
...
func (r *PostgresStore) StartToolCall(
	ctx context.Context,
	ownerID string,
	runID string,
	toolCallID string,
...
func (r *PostgresStore) CompleteToolCall(
	ctx context.Context,
	ownerID string,
	runID string,
	toolCallID string,
...
func (r *PostgresStore) FailToolCall(
	ctx context.Context,
	ownerID string,
	runID string,
	toolCallID string,
...
func (r *PostgresStore) ListToolCalls(
	ctx context.Context,
	ownerID string,
	runID string,
) ([]agentrun.ToolCall, error) {
...
func (r *PostgresStore) RecoverInterrupted(
	ctx context.Context,
) (int64, error) {
	command, err := r.database.Exec(ctx, `
UPDATE agent_runs
...
var _ agentcontext.Repository = (*PostgresStore)(nil)
var _ agentcontext.ManifestRepository = (*PostgresStore)(nil)
var _ agentrun.Repository = (*PostgresStore)(nil)
