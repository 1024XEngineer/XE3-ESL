...
func NewPostgresStore(
	...
	return &PostgresStore{database: database, ids: ids}, nil
}

func (r *PostgresStore) CreateThread(
	ctx context.Context,
	ownerID string,
...
func (r *PostgresStore) ListThreads(
	ctx context.Context,
	ownerID string,
) ([]conversation.Thread, error) {
...
func (r *PostgresStore) PageThreads(
	ctx context.Context,
	ownerID string,
	limit int,
...
func (r *PostgresStore) FindThread(
	ctx context.Context,
	ownerID string,
	threadID string,
) (conversation.Thread, error) {
...
func (r *PostgresStore) FindFocusedThread(
	ctx context.Context,
	ownerID string,
...
func (r *PostgresStore) SetFocusedThread(
	ctx context.Context,
	ownerID string,
	threadID string,
) (conversation.Thread, error) {
...
func (r *PostgresStore) ClearFocusedThread(
	ctx context.Context,
	ownerID string,
) error {
	var deleted int64
...
func (r *PostgresStore) DeleteThread(
	ctx context.Context,
	ownerID string,
	threadID string,
) error {
...
func (r *PostgresStore) SetActiveMatter(
	ctx context.Context,
	ownerID string,
	threadID string,
	matterID string,
...
func (r *PostgresStore) AppendUserMessage(
	ctx context.Context,
	ownerID string,
	threadID string,
...
func (r *PostgresStore) ListMessages(
	ctx context.Context,
	ownerID string,
	threadID string,
) ([]conversation.Message, error) {
...
func (r *PostgresStore) PageMessages(
	ctx context.Context,
	ownerID string,
	threadID string,
	limit int,
...
var _ conversation.Repository = (*PostgresStore)(nil)
