...
func TestCompletionIntakeCreatesOneEvaluationAndAcknowledgesHandoff(
	...
	if sweep != (CompletionIntakeSweepResult{Claimed: 1, Delivered: 1}) ||
		...
		evaluations.calls != 1 ||
		evaluations.request.SceneType != SceneInterview ||
...
func TestCompletionEvaluationRouteCoversEveryFormalSceneModel(t *testing.T) {
	...
	tests := []struct {
		...
		{scene.SceneFamilyInterview, scene.SceneModelProjectExperienceDeepDive, SceneInterview, InterviewShadowStrategyRef},
		{scene.SceneFamilyInterview, scene.SceneModelInterviewBasicDialogue, SceneInterview, InterviewShadowStrategyRef},
		{scene.SceneFamilyExam, scene.SceneModelIELTSSpeakingPart1, SceneIELTSSpeaking, GeneralSceneStrategyRef},
		{scene.SceneFamilyExam, scene.SceneModelIELTSSpeakingPart2, SceneIELTSSpeaking, GeneralSceneStrategyRef},
		{scene.SceneFamilyExam, scene.SceneModelIELTSSpeakingPart3, SceneIELTSSpeaking, GeneralSceneStrategyRef},
		{scene.SceneFamilyExam, scene.SceneModelIELTSSpeakingFullMock, SceneIELTSSpeaking, IELTSSpeakingShadowStrategyRef},
		{scene.SceneFamilyExam, scene.SceneModelExamBasicDialogue, SceneIELTSSpeaking, GeneralSceneStrategyRef},
		{scene.SceneFamilyWorkplace, scene.SceneModelProgressAndRiskUpdate, SceneOverseasWorkplace, GeneralSceneStrategyRef},
		{scene.SceneFamilyWorkplace, scene.SceneModelWorkplaceBasicDialogue, SceneOverseasWorkplace, GeneralSceneStrategyRef},
		{scene.SceneFamilyDaily, scene.SceneModelHotelCheckinAndIssueHandling, SceneOverseasDaily, GeneralSceneStrategyRef},
		{scene.SceneFamilyDaily, scene.SceneModelDailyBasicDialogue, SceneOverseasDaily, GeneralSceneStrategyRef},
	}
...
func completionSceneTypeFixture(family scene.SceneFamily) SceneType {
	switch family {
	case scene.SceneFamilyInterview:
		return SceneInterview
	case scene.SceneFamilyExam:
		return SceneIELTSSpeaking
	case scene.SceneFamilyDaily:
		return SceneOverseasDaily
	case scene.SceneFamilyWorkplace:
		return SceneOverseasWorkplace
	default:
		return ""
	}
}
