...
// evaluation.Evaluation; callers cannot choose a strategy, scope, scene, or channel.
...
func ValidateInterviewShadowCreateRequest(request evaluation.CreateRequest) error {
