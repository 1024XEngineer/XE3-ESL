...
// HTTPApplication is the authenticated application boundary used by the
...
type InterviewReportResource struct {
	...
	EvaluationStatus     evaluation.Status
	IsFinal              bool
	Report               *evaluationreport.InterviewReport
	StableFailure        *EvaluationFailure
}
...
type IELTSSpeakingReportResource struct {
	...
	EvaluationStatus     evaluation.Status
	IsFinal              bool
	Report               *evaluationreport.IELTSSpeakingReport
	StableFailure        *EvaluationFailure
}
...
func NewHTTPHandler(application HTTPApplication) (*HTTPHandler, error) {
	if application == nil {
...
type interviewReportResponse struct {
	...
	IsFinal              bool                              `json:"is_final"`
	StatusURL            string                            `json:"status_url"`
	Report               *evaluationreport.InterviewReport `json:"report,omitempty"`
	StableFailure        *EvaluationFailure                `json:"stable_failure,omitempty"`
}
