...
type questionResolverStub struct{}

func (questionResolverStub) ResolveQuestion(
	_ context.Context,
	reference QuestionReference,
) (ResolvedQuestion, error) {
	return ResolvedQuestion{
		Reference: reference,
		Prompt:    "Do you enjoy music?",
	}, nil
}
...
func TestSpeechServiceUsesResolvedQuestion(t *testing.T) {
	synthesizer := &ieltsSpeechSynthesizerStub{}
	service, err := NewSpeechService(questionResolverStub{}, synthesizer)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSpeechServiceReportsProviderFailure(t *testing.T) {
