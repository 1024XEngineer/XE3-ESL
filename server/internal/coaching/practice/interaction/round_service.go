...
// RoundStore is owned by Practice Interaction. Implementations must scope every
...
//
// Confirmation persistence supplies local checkpoints to the Practice Interaction
...
func NewRoundService(
	...
	return NewRoundServiceWithRecordings(
		store,
		vault,
		recognizer,
		recordedRecognizer,
...
func NewRoundServiceWithRecordings(
	store RoundStore,
	vault TemporaryAudioVault,
	recognizer SpeechRecognizer,
	recordedRecognizer SpeechRecognizer,
	...
	if store == nil || vault == nil || recognizer == nil ||
		...
		return nil, errors.New("practice interaction: round dependencies are required")
	}
	if (recordings == nil) != (recordingConfirms == nil) {
...
func (service *RoundService) SubmitTextAnswer(
	ctx context.Context,
	actor requestcontext.Actor,
	respondentParticipantID string,
...
func (service *RoundService) Transcribe(
	ctx context.Context,
	actor requestcontext.Actor,
	respondentParticipantID string,
	command TranscribeVoiceCommand,
...
func (service *RoundService) completeTranscription(
	ctx context.Context,
	actor requestcontext.Actor,
	reservation TranscriptionReservation,
...
func (service *RoundService) failTranscription(
	ctx context.Context,
	actor requestcontext.Actor,
	reservation TranscriptionReservation,
	err error,
...
func (service *RoundService) Confirm(
	ctx context.Context,
	actor requestcontext.Actor,
	...
	if service.recordings != nil {
		turn, err := service.recordingConfirms.ReserveRecordingConfirmation(
			ctx,
			actor,
			command,
		...
		if !validRecordedVoiceTurn(candidate, turn) {
...
func (service *RoundService) ConfirmText(
	ctx context.Context,
	actor requestcontext.Actor,
	command ConfirmVoiceTurnCommand,
) (practice.Turn, error) {
	...
	if !validRecordedVoiceTurn(candidate, turn) || turn.AudioAssetID != "" {
		return practice.Turn{}, ErrVoiceRoundConflict
	}
	return turn, nil
}
...
func (service *RoundService) GetTranscriptionCandidate(
	ctx context.Context,
	actor requestcontext.Actor,
	candidateID string,
) (TranscriptionCandidate, error) {
...
func validRecordedVoiceTurn(
	...
	return turn.AudioAssetID == "" || sharedmedia.ValidUUID(turn.AudioAssetID)
}
