...
// AudioAsset is Practice Voice's durable metadata for a protected recording.
...
// ValidAudioAssetIdentifier reports whether an identifier is valid at the
// Practice Voice domain boundary.
