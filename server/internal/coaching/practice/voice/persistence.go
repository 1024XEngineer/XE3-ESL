// This file defines the durable Practice Voice persistence boundary. Concrete
...
var (
	ErrPersistenceInvalid     = errors.New("practice_voice_persistence_invalid")
	ErrPersistenceNotFound    = errors.New("practice_voice_persistence_not_found")
	ErrPersistenceConflict    = errors.New("practice_voice_persistence_conflict")
	ErrPersistenceUnavailable = errors.New("practice_voice_persistence_unavailable")
	ErrActorDeleted           = errors.New("practice_voice_actor_deleted")
)

// Actor is the trusted identity presented to Practice Voice by the application
...
// PersistenceStore is the Practice Voice durable boundary. It returns only
// voice-practice data and never imports Review repositories.
