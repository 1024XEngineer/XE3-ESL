...
// SameQuestionRetryTurnPort exposes only the actor-owned Practice Voice draft
...
func NewSameQuestionRetryApplication(
	...
	if turns == nil || practice == nil || rounds == nil {
...
func (application *SameQuestionRetryApplication) Transcribe(
	...
	if application == nil || application.turns == nil ||
		application.practice == nil || application.rounds == nil ||
	...
	if draft.Status != RetryTurnAnswering {
