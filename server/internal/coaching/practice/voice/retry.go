...
func (application *SameQuestionRetryApplication) Transcribe(
	...
	if draft.Status != practiceinput.RetryTurnAnswering {
...
func (application *SameQuestionRetryApplication) Confirm(
	...
	if draft.Status == practiceinput.RetryTurnConfirmed &&
...
func validRetryDraft(
	...
	return draft.TurnID == retryTurnID &&
		...
		(draft.Status == practiceinput.RetryTurnAnswering ||
			draft.Status == practiceinput.RetryTurnConfirmed)
}

func validConfirmedRetry(
	before practiceinput.RetryTurnDraft,
	after practiceinput.RetryTurnDraft,
	candidate practiceinput.TranscriptionCandidate,
	turn practice.Turn,
) bool {
