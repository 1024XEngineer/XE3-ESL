...
// Practice Voice reservation ID. This lets confirmation recover after a process
// restart without adding an object-storage foreign key to the transcription
// tables.
...
// CleanupAccountData is Practice Voice's module boundary for account-data
...
// a new row could appear after the final Has query. Practice Voice neither reads
