...
func TestCatalogPreviewResolverRoutesExplicitSceneIntents(t *testing.T) {
	...
	tests := map[string]string{
		...
		"我的航班延误了":           "scn_travel_airport_checkin",
		"航班取消后怎么询问信息":       "scn_travel_airport_checkin",
		"我需要确认登机口变更":        "scn_travel_airport_checkin",
		...
		"我想练习主动反馈":          "scn_workplace_feedback_conflict",
		"我需要处理与同事的工作分歧":     "scn_workplace_conflict_resolution",
		"我想练习处理分歧":          "scn_workplace_conflict_resolution",
