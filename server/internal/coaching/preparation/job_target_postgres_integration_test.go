...
const (
	testIntegrationSceneID           = "scn_programmer_interview"
	testIntegrationTechnicalRoleID   = "role_technical_interviewer"
	testIntegrationHRRoleID          = "role_hr_interviewer"
	testIntegrationFullOptionID      = "option_full_simulation"
	testIntegrationTechnicalOptionID = "option_technical_focus"
)
...
func TestPostgresJobTargetConfirmationRejectsMultiRoleInterview(
	...
	multiRole.CatalogRecommendation.PracticeOptionID =
		testIntegrationFullOptionID
	multiRole.CatalogRecommendation.SelectedRoleIDs = []string{
		testIntegrationTechnicalRoleID,
		testIntegrationHRRoleID,
	}
	if _, err := repository.CompleteAnalysis(
		ctx,
		claim,
...
func jobTargetCandidate(
	...
	return preparation.JobTargetCandidate{
		...
		CatalogRecommendation: preparation.JobTargetCatalogRecommendation{
			SceneID:      testIntegrationSceneID,
			SceneVersion: 1,
			SelectedRoleIDs: []string{
				testIntegrationTechnicalRoleID,
			},
			PracticeOptionID: testIntegrationTechnicalOptionID,
		},
	}
}
