...
func (pipeline *OCRFallbackPipeline) Parse(
	...
	if pipeline == nil || pipeline.native == nil {
		return resume.Content{}, errors.New("resume OCR pipeline is invalid")
	}
...
func (pipeline *OCRFallbackPipeline) ParseURL(
	...
	if pipeline == nil || pipeline.ocr == nil || pipeline.fields == nil ||
		ctx == nil || ctx.Err() != nil {
		return resume.Content{}, errors.New("resume OCR pipeline input is invalid")
	}
...
// OCRVersion returns the version recorded only for OCR-generated revisions.
