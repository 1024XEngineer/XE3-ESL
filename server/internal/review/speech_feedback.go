...
var (
	ErrInvalidSpeechFeedback       = errors.New("review: invalid SpeechFeedback")
	ErrSpeechFeedbackNotFound      = errors.New("review: SpeechFeedback not found")
	ErrSpeechFeedbackNotApplicable = errors.New("review: SpeechFeedback not applicable")
	ErrSpeechFeedbackConflict      = errors.New("review: SpeechFeedback source conflict")
	ErrSpeechFeedbackClaimLost     = errors.New("review: SpeechFeedback claim lost")
)
