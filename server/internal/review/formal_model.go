...
func (r ReviewResult) MarshalJSON() ([]byte, error) {
	...
	var overall *int
	if r.OverallScorePresent || r.OverallScore != 0 || r.legacyFormat {
...
func (r *ReviewResult) UnmarshalJSON(encoded []byte) error {
	...
	*r = ReviewResult{
		...
		OverallScorePresent:         wire.OverallScore != nil,
...
const (
	...
	SummaryProvisional          SummaryEligibility = "provisional"
...
func deriveSummaryEligibility(
	...
	if source.EvaluationContext.ContextType == ContextIELTSSpeakingPart2 {
		return SummaryProvisional,
			[]string{"pronunciation_audio_evidence_unavailable"},
			nil
	}
...
func validateGenerated(
	...
	if err != nil || eligibility == SummaryInsufficientEvidence {
		return ReviewResult{}, nil, ErrInvalidReview
	}
	generated.Result.SummaryEligibility = eligibility
	generated.Result.InsufficientEvidenceReasons = slices.Clone(reasons)
...
func validatePersistedReviewResult(result ReviewResult) error {
	...
	if (result.SummaryEligibility != SummaryEligible &&
		result.SummaryEligibility != SummaryProvisional) ||
		result.OverallScore < 0 ||
