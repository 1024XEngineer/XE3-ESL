...
import (
	...
	"github.com/1024XEngineer/XE3-ESL/server/internal/coaching/preparation/interviewresume/parser"
...
func TestPipelineLiveQianwen(t *testing.T) {
	...
	generator, err := app.NewResumeFieldGenerator(textConfiguration)
	if err != nil {
...
func containsGPA(content preparation.ResumeMaterial, expected string) bool {
