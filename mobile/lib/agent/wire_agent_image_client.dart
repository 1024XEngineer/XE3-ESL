...
final class WireAgentImageClient implements AgentImageClient {
  ...
  @override
  Future<AgentImageContent> getImageContent({
...
AgentImageContent _decodeContent(Uint8List bytes) {
  final object = _jsonObject(bytes);
  if (object.length != 2 ||
  ...
  return AgentImageContent(url: url, expiresAt: expiresAt);
}
